...
public class MainActivity extends AppCompatActivity {
    ...
    public Integer size;
    boolean lnChecked = false;

    public void addBtTg(View v) {
        ...
        screen.setText("ln( ");
        size = screen.getText().length();
        screen.setText(screen.getText() + temp);
        lnChecked = true;
        movecarot();
    }
    ...
    public void result(View v) {
        if (!TextUtils.isEmpty(screen.getText().toString())
            ...
            if (lnChecked) {
                ...
                firstValue = Double.parseDouble(s.substring(size,screen.getText().length()));

                Double finalValue = Math.log(firstValue);
                String result = finalValue.toString();
